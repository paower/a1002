...
<div class="big_width100">
	<div class="tips">*请绑定持卡人本人的银行卡，姓名一经填写不可修改!</div>
	<div class="add_bank_add_gr">
		...
		<div class="fill_sty add_gr_b10">
			<p>开户银行</p>
			<div class="demo">
				<select style="margin-top:12px;background: none;border: 0;color:#107fc4;font-size: 15px;" isval="true" msg="<?php echo (L("addcard3")); ?>" id="khy">
		...
		<div class="fill_sty add_gr_b10 mababno">
            ...
            <p>支付宝账号</p>
            <input type="text" name="alipay_number" placeholder="请输入支付宝账号" autocomplete="off" id="alipay_number">
        </div>
	</div>
...
<script type="text/javascript">
    ...
    $('#confirm').on('click', function(){
		...
		var alipay_number = $.trim($('#alipay_number').val());
        $.post("<?php echo U('Growth/Addbank');?>",{crkxm:crkxm,khy:khy,yhk:yhk,khzy:khzy,alipay_number:alipay_number},function(mes){
            if(mes.status == 1){
