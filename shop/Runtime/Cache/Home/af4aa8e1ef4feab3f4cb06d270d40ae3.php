...
<body style="background: #ebebeb;">
    <div class="user-top">
		<span class="user-headleft" id="logox"><img id="bgl" src="/Public/home/wap/heads/<?php echo ($uinfo['img_head']); ?>"/></span>
		<span class="user-headright">
			<div class="username"><?php echo ($uinfo['username']); ?></div>
			<div>
				等级:
				<?php if($uinfo['unlock'] == 0 ): ?>动态会员
					<?php elseif($uinfo['unlock'] == 1): ?> 静态会员<?php endif; ?>
			</div>
		</span>
	</div>
    <!-- <div class="user-top"> -->
       ...
       <!-- <ul class="user-top-msg"> -->
			<!-- <li>等级 -->
				<!-- <?php if($uinfo['unlock'] == 0 ): ?>动态会员 -->
					<!-- <?php elseif($uinfo['unlock'] == 1): ?> 静态会员 -->
				<!--<?php endif; ?> -->
			<!-- </li> -->
			<!-- <li><?php echo ($uinfo['username']); ?></li> -->
			<!-- <li></li> -->
       <!-- </ul> -->
    <!-- </div> -->
    ...
    <div class="setlistbox">
		<div class="addBankCard">
			<a href="<?php echo U('User/Usercenter');?>" class="clear_wl"> <i class="layui-icon layui-icon-face-smile" style="font-size: 30px; color: #1E9FFF;"></i><p>个人中心</p></a>
		</div>
		<div class="addBankCard">
			<a href="<?php echo U('User/Teamdets');?>" class="clear_wl"> <p>我的团队</p></a>
		</div>
		
		<div class="addBankCard">
			<a href="<?php echo U('User/Security');?>" class="clear_wl"> <p>安全中心</p></a>
		</div>
		
       
		<div class="addBankCard">
			<a href="<?php echo U('User/Complaint');?>" class="clear_wl"> <p>投诉建议</p></a>
		</div>
		 <div class="addBankCard">
			<a href="<?php echo U('User/News');?>" class="clear_wl"> <p>系统公告</p></a>
		</div>
    </div>
    <div class="loginout" style="margin-top:78px;">
    ...
    <div class="footer-fan">
       ...
       <div class="big_width100">
	      <div class="shezhi">
	      	 <div class="sett_toux clear_wl" style="display: none">
			  <!--   <div class="upload">
				 ...
				 <!--新的更换头像EEEE-->
		      	 	<div class="sett_uid_xy">
			    		...
			    		<p><?php echo (L("reput")); ?>
							<?php $__FOR_START_16063__=0;$__FOR_END_16063__=$uinfo['user_credit'];for($i=$__FOR_START_16063__;$i < $__FOR_END_16063__;$i+=1){ ?><span><img src="/Public/home/wap/images/aix-icon.png"></span><?php } ?>
			    		</p>
			    	</div>
	      	 </div>
