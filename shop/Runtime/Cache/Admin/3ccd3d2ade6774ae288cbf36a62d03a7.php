...
<body class="admin_config_group" >
   ...
   <div id="main" class="col-xs-12 col-sm-9 main" style="overflow-y: scroll;">
		...
		<ul class="breadcrumb">
			...
			<li class="text-muted"><?php echo isset($info)?'修改':匹配;?></li>
		</ul>
					...
					<div class="builder-tabs builder-form-tabs">
						...
						<ul class="nav nav-tabs">
							<li <?php if(($type) != "over"): ?>class="active"<?php endif; ?> >
								<a href="<?php echo U('ActivateNum/index');?>">匹配列表</a>
							</li>
						</ul>
					</div>
											  ...
											  <thead>
												...
												<tbody>
													...
													<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
															<td><input type="checkbox" name="subid[]" value="<?php echo ($data["id"]); ?>"></td>
															...
															<td>
																<?php if($data['form'] == 0): ?><span style="color:blue">买入订单</span>
												...
												<tr>
													<td>
								                        ...
								                        <input  type="submit" class="btn btn-primary" id="submit" name="submit" onclick="return pipei(<?php echo ($data["id"]); ?>)" value="匹配">
													</td>
												</tr>
											</table>
										</div>
	...
	<script type="text/javascript" src="/Public/libs/lyui/dist/js/pipei.js"></script>
