				...
				<div class="builder-toolbar">
					<div class="row">
						...
						<div class="col-xs-12 col-sm-12 clearfix">
							<form class="form" method="get" action="<?php echo U('User/quotelist');?>">
								<div class="form-group right">
									...
									<div style="width:250px" class="input-group search-form">
											...
											<input  type="text" name="username" class="search-input form-control" value="<?php echo ($_GET["keyword"]); ?>" placeholder="输入会员ID">
										...
										<div class="panel panel-default table-responsive">
											<table class="table table-bordered table-striped table-hover">
											  <thead>
												...
												<tbody>
													<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i; if($data['id'] != ''): ?><tr>
															...
															<td>
																<?php if($data['status'] == 1): ?>未使用
																<?php else: ?>
																	已使用<?php endif; ?>
															</td>
															<!-- <td> -->
																<!-- <?php if($data['pay_state'] == 1): ?>-->
																	<!-- 等待解冻 -->
																<!-- <?php elseif($data['pay_state'] == 2): ?> -->
																	<!-- 已解冻，等待领取 -->
																<!-- <?php elseif($data['pay_state'] == 3): ?> -->
																	<!-- 已完成 -->
																<!--<?php endif; ?> -->
															<!-- </td> -->
