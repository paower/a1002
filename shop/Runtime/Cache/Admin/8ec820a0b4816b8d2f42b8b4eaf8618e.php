                                ...
                                <div class="col-xs-12 col-sm-12 clearfix">
                                        <form class="form" method="post" action="">
                                            <div class="form-group right">
                                              ...
                                              <div class="sum">
                                              	<div>余额增加总数:<?php echo ($yue_add); ?></div>
                                                <div>余额减少总数:<?php echo ($yue_red); ?></div>
                                                <div>积分增加总数:<?php echo ($jifen_add); ?></div>
                                                <div>积分减少总数:<?php echo ($jifen_red); ?></div>
                                              </div>
                                            </div>
                                        </form>
                                    </div>
                                            ...
                                            <?php  $store=M('store'); ?>
                                                <tbody>
                                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                                            ...
                                                            <td>
                                                                <?php echo ($data["get_nums"]); ?>
                                                            </td>
                                                            <td><?php echo (date('Y-m-d H:i:s',$data['get_time'])); ?></td>
