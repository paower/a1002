            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                            <div class="row" >
                                <div class="col-xs-12">
                                    <form action="/admin/News/user_agreem.html" method="post" class="form-horizontal form form-builder">
                                        <div class="form-type-list">
                                            <div class="form-group hidden item_id ">
                                             ...
                                             <div class="form-group item_title ">
                                                ...
                                                <div class="right">
                                                    <input type="text" class="form-control input" name="title" value="<?php echo ($info["title"]); ?>" placeholder="标题" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="right">
                                                    <textarea class="form-control textarea" style="height:400px;" rows="5" name="content"><?php echo ($info["content"]); ?></textarea>
                                                    <span class="check-tips text-muted small">填写系统公告</span>
                                                </div>
                                            </div>
