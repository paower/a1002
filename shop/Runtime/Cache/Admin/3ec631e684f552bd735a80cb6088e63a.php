            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                            <div class="row" >
                                <div class="col-xs-12">
                                    <form action="/admin/User/edit/id/999854.html" method="post" class="form-horizontal form form-builder">
                                        <div class="form-type-list">
                                            ...
                                            <div class="form-group item_title ">
                                                ...
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="automatic_paidan_day" value="<?php echo ($info["automatic_paidan_day"]); ?>" placeholder="天数">
                                                </div>（0表示关闭）
                                            </div>
                                            ...
                                            <div class="form-group item_title ">
                                               ...
                                               <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                <input type="radio" name="activate"  
                                                 <?php if($info[activate] == 1): ?>checked<?php endif; ?> value="1">
                                               ...
                                               <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                <input type="radio" name="activate"  
                                                <?php if($info[activate] == 0): ?>checked<?php endif; ?> value="0">
                                                <span class="cui-control-indicator"></span>
                                                <span>未激活</span>
                                               </label>
                                            ...
                                            <div class="form-group item_title ">
                                                ...
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="hold_name" value="<?php echo ($user_bank['hold_name']); ?>" placeholder="持卡人姓名">
                                                </div>
                                            </div>
                                            <input name="id" value="<?php echo ($user_bank['id']); ?>" type="hidden" />
                                            <div class="form-group item_title ">
                                                <label class="left control-label">开户银行：</label>
                                                <div class="right">
                                                    <select name="card_id">
                                                        <option value="0">请选择开户银行</option>
                                                        <?php if(is_array($bakinfo)): $i = 0; $__LIST__ = $bakinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['q_id']); ?>" <?php echo ($user_bank['card_id']==$vo['q_id']?'selected':''); ?>><?php echo ($vo['banq_genre']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group item_title ">
                                                ...
                                                <div class="right">
                                                    <input type="number" class="form-control input text" name="card_number" value="<?php echo ($user_bank['card_number']); ?>" placeholder="银行卡号">
                                                </div>
                                            </div>
                                            <div class="form-group item_title ">
                                                <label class="left control-label">开户支行：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="open_card" value="<?php echo ($user_bank['open_card']); ?>" placeholder="开户支行">
                                                </div>
                                            </div>
                                            <div class="form-group item_title ">
                                                <label class="left control-label">支付宝账号：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="alipay_number" value="<?php echo ($user_bank['alipay_number']); ?>" placeholder="支付宝账号">
                                                </div>
                                            </div>
                                          <!--   <div class="form-group item_title ">
                                                <label class="left control-label">sex：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input" name="sex" value="<?php echo ($info["sex"]); ?>" placeholder="是否" >
                                                </div>
                                            </div> -->
                                            <div class="form-group item_title ">
                                               ...
                                               <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                <input type="radio" name="quanxian"  
                                                 <?php if($info[quanxian] == 1): ?>checked<?php endif; ?> value="1">
                                                <span class="cui-control-indicator"></span>
                                                <span>开启</span>
                                               </label>
                                               ...
                                               <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                <input type="radio" name="quanxian"  
                                                <?php if($info[quanxian] == 0): ?>checked<?php endif; ?> value="0">
                                                <span class="cui-control-indicator"></span>
                                                <span>关闭</span>
                                               </label>
                                            ...
                                            <div class="form-group item_title ">
                                               ...
                                               <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                <input type="radio" name="is_daili"  
                                                 <?php if($info[is_daili] == 1): ?>checked<?php endif; ?> value="1">
                                                <span class="cui-control-indicator"></span>
                                                <span>开启</span>
                                               </label>
                                               ...
                                               <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                <input type="radio" name="is_daili"  
                                                <?php if($info[is_daili] == 0): ?>checked<?php endif; ?> value="0">
                                                <span class="cui-control-indicator"></span>
                                                <span>关闭</span>
                                               </label>
