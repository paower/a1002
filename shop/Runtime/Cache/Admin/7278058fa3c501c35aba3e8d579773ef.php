                                ...
                                <table class="table table-condensed">
                                    <tbody>
										...
										<!-- <tr> -->
                                            <!-- <td>总冻结金额</td> -->
                                            <!-- <td> -->
                                                <!-- <a title="查看" href="<?php echo U('Finance/cannot');?>"> -->
                                                   <!-- <?php echo ($payout_dj); ?> -->
                                                <!-- </a> -->
                                            <!-- </td> -->
                                        <!-- </tr> -->
                                        <tr>
                                            <td>今日卖出金额</td>
                                            <td>
                                                <a title="查看" href="<?php echo U('Finance/index');?>">
                                                   <?php echo ($payin_num+0); ?>
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
