                        ...
                        <div class="tab-content" >
                            ...
                            <div id="tab1" class="tab-pane active" >
                                <div class="col-xs-12">
                                        ...
                                        <form action="/admin/User/AddFruits/id/100499.html" method="post" class="form-horizontal form form-builder form1">
                                        <div class="form-type-list">
                                           ...
                                           <div class="form-group item_title ">
                                            ...
                                            <!-- <div class="form-group item_title "> -->
                                                ...
                                                <!-- <div class="right"> -->
                                                    <!-- <?php echo ($info['red_integral']); ?> -->
                                                <!-- </div> -->
                                            <!-- </div> -->

                                             <div class="form-group item_title "> 
                                                <label class="left control-label">分享佣金：</label> 
                                                <div class="right"> 
                                                     <?php echo ($info['dt_jifen']); ?>
                                                 </div> 
                                            </div>
                                            <div class="form-group item_title ">
                                                <label class="left control-label">排单币：</label>
                                                <div class="right">
                                                    <?php echo ($info['paidan']); ?>
                                                </div>
                                            </div>
                                            <div class="form-group item_title ">
                                                <label class="left control-label">总收益：</label>
                                                <div class="right">
                                                    <?php echo ($info['total_revenue']); ?>
                                                </div>
                                            </div>
                                            <!-- <div class="form-group item_title "> -->
                                                <!-- <label class="left control-label">激活码：</label> -->
                                                <!-- <div class="right"> -->
                                                    <!-- <?php echo ($info['active_num']); ?> -->
                                                <!-- </div> -->
                                            <!-- </div> -->
                                                ...
                                                <div class="right">
                                                    <select name="opetype" class="form-control cui-select select">、
                                                        <option value="1" selected="">余额</option>
                                                         <option value="2">分享佣金</option>
                                                        <option value="3">排单币</option>
                                                        <!-- <option value="4">激活码</option> -->
                                                        <!-- <option value="5">积分</option> -->
                                                        <option value="6">总收益</option>
                                                    </select>
                                                </div>
                                            </div>
                            ...
                            <!-- 卡片2 -->
                             <div id="tab2" class="tab-pane" >
                                    <div class="col-xs-12">
                                        ...
                                        <div style="height:20px;" ></div>
                                        <form action="/admin/User/AddFruits/id/100499.html" method="post" class="form-horizontal form form-builder form2">
                                        <div class="form-type-list">
                                            <div class="form-group hidden item_id ">
                                                <label class="left control-label">ID：</label>
                                                <div class="right">
